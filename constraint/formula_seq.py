...
seq_constraints = [
    ...
    {
        "columns": [
            "M09_포인트_마일리지_월적립_B0M",
            "M08_포인트_마일리지_월적립_B0M",
            "M07_포인트_마일리지_월적립_B0M",
        ],
    ...
    # M08
    {
        "columns": ["M08_인입횟수_ARS_B0M", "M07_인입후경과월_ARS"],
    ...
    },
    {
        ...
        "fname": "cfs_06_0207",
        "type": "formula",
        "content": "M08_OS구분코드 = M07_OS구분코드",
    },
    # M09
    {
        "columns": ["M09_인입횟수_ARS_B0M", "M08_인입후경과월_ARS"],
    ...
    },
    {
        ...
        "fname": "cfs_06_0314",
        "type": "formula",
        "content": "M09_OS구분코드 = M07_OS구분코드",
    },
    # M10
    {
        "columns": ["M10_인입횟수_ARS_B0M", "M09_인입후경과월_ARS"],
    ...
    # M11
    {
        "columns": ["M11_인입횟수_ARS_B0M", "M10_인입후경과월_ARS"],
    ...
    # M12
    {
        "columns": ["M12_인입횟수_ARS_B0M", "M11_인입후경과월_ARS"],
    ...
    {
        "columns": [
            "M09_이용금액_페이_오프라인_B0M",
            "M08_이용금액_페이_오프라인_B0M",
            "M07_이용금액_페이_오프라인_B0M",
        ],
    ...
    {
        "columns": ["M10_이용건수_신용_B0M", "M09_이용건수_신용_B0M", "M09_이용건수_신용_B0M"],
        "output": "M10_이용건수_신용_R3M",
        "fname": "cfs_03_1493",
        "type": "formula",
        "content": "M10_이용건수_신용_R3M = M10_이용건수_신용_B0M + M09_이용건수_신용_B0M + M09_이용건수_신용_B0M",
    },
    {
        "columns": ["M10_이용건수_신판_B0M", "M09_이용건수_신판_B0M", "M09_이용건수_신판_B0M"],
        "output": "M10_이용건수_신판_R3M",
        "fname": "cfs_03_1494",
        "type": "formula",
        "content": "M10_이용건수_신판_R3M = M10_이용건수_신판_B0M + M09_이용건수_신판_B0M + M09_이용건수_신판_B0M",
    },
    {
        "columns": ["M10_이용건수_일시불_B0M", "M09_이용건수_일시불_B0M", "M09_이용건수_일시불_B0M"],
        "output": "M10_이용건수_일시불_R3M",
        "fname": "cfs_03_1495",
        "type": "formula",
        "content": "M10_이용건수_일시불_R3M = M10_이용건수_일시불_B0M + M09_이용건수_일시불_B0M + M09_이용건수_일시불_B0M",
    },
    {
        "columns": ["M10_이용건수_할부_B0M", "M09_이용건수_할부_B0M", "M09_이용건수_할부_B0M"],
...
@constraint_udf
def cfs_02_0071(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
    ...
    res = dd.apply(
        lambda x: 12 if x[0] == 0 else (0 if x[0] > x[1] else x[2] + 1), axis=1
    )
    return res


@constraint_udf
def cfs_02_0074(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0077(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0091(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
    ...
    res = dd.apply(
        lambda x: 3 if x[0] == 0 else (0 if x[0] > x[1] else x[2] + 1), axis=1
    )
    return res


@constraint_udf
def cfs_02_0092(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0125(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0128(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0131(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0145(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0146(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0139(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0179(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0182(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0185(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0199(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0200(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0233(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0236(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0239(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0253(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0254(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0287(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0290(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0293(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0307(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_02_0308(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
        IF M12_한도요청거절건수 == 0 THEN M12_한도심사거절후경과월 = 3
        ELIF M12_한도요청거절건수 > M11_한도요청거절건수 THEN M12_한도심사거절후경과월 = 0
        ELSE M12_한도심사거절후경과월 =  M11_한도심사거절후경과월 + 1
    """
...
def cfs_04_0112(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    ...
    res = dd.apply(
        lambda x: "0" if (x[0] == "0") & (x[1] == "0") & (x[2] == "0") else "1", axis=1
    )
    return res
...
def cfs_04_0164(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    ...
    res = dd.apply(lambda x: "0" if (x[0] == "0") & (x[1] == "0") else "1", axis=1)
    return res
...
# 05_M07
@constraint_udf
def cfs_05_0013(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 05_M08
@constraint_udf
def cfs_05_0114(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
    ...
    res = dd.apply(
        ...
        if x[0] > 0
            ...
            0
            if (x[0] == 0) & (x[1] == 0)
            else (1 if (x[0] == 0) & (x[1] > 0) else x[2] + 1)
        ),
        axis=1,
    )
    return res
...
# 05_M09
@constraint_udf
def cfs_05_0215(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 05_M10
@constraint_udf
def cfs_05_0316(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 05_M11
@constraint_udf
def cfs_05_0417(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 05_M12
@constraint_udf
def cfs_05_0518(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_05_0529(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 06_M07
@constraint_udf
def cfs_06_0007(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0014(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0018(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0022(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0033(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0040(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0092(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
# 06_M08
@constraint_udf
def cfs_06_0114(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
    ...
    res = dd.apply(
        ...
        if x[0] > 0
            ...
            0
            if (x[1] == 0) & (x[2] == 0)
            else (1 if (x[1] > 0) & (x[2] == 0) else (0 if x[2] == 5 else x[2] + 1))
        ),
        axis=1,
    )
    return res
...
@constraint_udf
def cfs_06_0121(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0125(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0129(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0140(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0147(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0199(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
    ...
    res = dd.apply(
        ...
        if x[0] > 0
            ...
            0
            if (x[1] == 0) & (x[2] == 0)
            else (12 if (x[1] == 0) & (x[2] == 12) else min(x[2] + 1, 12))
        ),
        axis=1,
    )
    return res
...
@constraint_udf
def cfs_06_0207(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    """
    formula:
        M08_OS구분코드 = M07_OS구분코드
    """
    res = df["M07_OS구분코드"]
    return res
...
# 06_M09
@constraint_udf
def cfs_06_0221(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0228(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0232(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0236(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0247(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0254(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0306(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0314(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    """
    formula:
        M09_OS구분코드 = M07_OS구분코드
    """
    res = df["M07_OS구분코드"]
    return res
...
# 06_M10
@constraint_udf
def cfs_06_0328(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0335(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0339(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0343(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0354(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0361(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0413(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0421(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    """
    formula:
        M10_OS구분코드 = M07_OS구분코드
    """
    res = df["M07_OS구분코드"]
    return res
...
# 06_M11
@constraint_udf
def cfs_06_0435(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0442(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0446(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0450(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0461(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0468(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0520(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0528(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    """
    formula:
        M11_OS구분코드 = M07_OS구분코드
    """
    res = df["M07_OS구분코드"]
    return res
...
# 06_M12
@constraint_udf
def cfs_06_0542(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0549(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0553(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0557(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0568(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0575(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0627(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_06_0635(df: pd.DataFrame) -> Union[pd.Series, List[str]]:
    """
    formula:
        M12_OS구분코드 = M07_OS구분코드
    """
    res = df["M07_OS구분코드"]
    return res
...
def cfs_03_0262(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    ...
    res = dd.apply(
        lambda x: 0 if x[0] > 0 else (6 if x[1] > 6 else (1 if x[1] < 1 else x[1])),
        axis=1,
    )
    return res
...
@constraint_udf
def cfs_03_0263(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0264(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0265(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0266(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0267(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0268(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0269(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0270(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0271(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0272(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0273(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0724(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0725(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0726(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0727(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0728(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0729(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0730(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0731(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0732(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0733(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_0734(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
def cfs_03_0736(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    ...
    res = dd.apply(
        lambda x: 999 if pd.isna(x[0]) else (x[2] + 1 if x[0] == x[1] else 0), axis=1
    )
    return res
...
@constraint_udf
def cfs_03_1184(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1185(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1186(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1187(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1188(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1189(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1190(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1191(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1192(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1193(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1194(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1195(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1369(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1370(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1371(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1372(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1373(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1645(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1646(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1647(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1648(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1649(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1650(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1651(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1652(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1653(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1654(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1655(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1656(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1830(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1831(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1832(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1833(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_1834(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2106(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2107(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2108(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2109(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2110(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2111(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2112(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2113(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2114(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2115(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2116(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2117(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2291(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2292(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2293(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2294(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2295(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2567(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2568(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2569(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2570(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2571(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2572(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2573(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2574(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2575(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2576(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2577(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2578(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2752(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2753(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2754(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2755(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
...
@constraint_udf
def cfs_03_2756(df: pd.DataFrame) -> Union[pd.Series, List[int]]:
    """
    formula:
