...
from model.synthesizer.other_loss import get_jsd
...
class CTABGANSynthesizer:
    ...
    def fit(
        ...
        *,
        ...
        # self.trsfm = TransformerModel(len_encoded, emsize, nhead, d_hid, nlayers, dropout).to(
        #     self.device
        # )
        ...
        for epoch in tqdm(range(self.epochs)):
            ...
            for i_g in tqdm(range(steps_per_epoch)):
                ...
                for i_ci in range(self.ci * self.accumulation_steps):
                    ...
                    # output = self.trsfm(data, src_mask)
